...
public class ClientFindByNameView extends javax.swing.JInternalFrame {
    ...
    public ClientFindByNameView(ClientServiceImp clientService) {
        initComponents();
        var clientFindByNameController = new ClientFindByNameController(this, clientService);
    }
    ...
    private void initComponents() {
        ...
        setBorder(javax.swing.BorderFactory.createTitledBorder(null, "Find by name form", javax.swing.border.TitledBorder.DEFAULT_JUSTIFICATION, javax.swing.border.TitledBorder.DEFAULT_POSITION, new java.awt.Font("Roboto", 0, 14))); // NOI18N
        setClosable(true);
        setIconifiable(true);
        ...
        jLabel1.setText("Find by name form");
