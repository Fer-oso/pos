...
public class ProductRegisterFormController extends MouseAdapter implements ActionListener {
   ...
   private final ProductRegisterForm productRegisterForm;
   private final ProductServiceImp productService;
    ...
    public ProductRegisterFormController(ProductRegisterForm productRegisterForm, ProductServiceImp productService) {
    ...
    private Product getDataOfForm(){
        ...
        Double price = Double.valueOf(productRegisterForm.getTxtPrice().getText());
        Integer stock = Integer.valueOf(productRegisterForm.getTxtStock().getText());
