...
public class ProductFindByNameController extends MouseAdapter implements ActionListener {
    ...
    public ProductFindByNameController(ProductFindByName productFindByName, ProductService productService) {
    ...
    private Product getDataOfForm() {
        ...
        product.setPrice(Double.parseDouble(productFindByName.getTxtPrice().getText()));
        product.setStock(Integer.parseInt(productFindByName.getTxtStock().getText()));
